                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-lg p-3 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all"
                        ...
                        <div className="col-span-1 md:col-span-2">
                            <label className="block text-slate-400 text-sm font-medium mb-2">Farm Name</label>
                            <input
                                type="text"
                    ...
                    <div className="space-y-6">
                        <div className="flex justify-between items-center">
                            <div>
                                ...
                                <p className="text-slate-400 text-sm mt-1">Receive alerts for severe weather and irrigation.</p>
                            </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                <h4 className="text-white font-medium">Data Synchronization</h4>
                                <p className="text-slate-400 text-sm mt-1">Automatically sync data when online.</p>
                            </div>
                            <label className="relative inline-flex items-center cursor-pointer">
                                <input
                                    type="checkbox"
