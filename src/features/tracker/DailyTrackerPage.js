...
const DailyTrackerPage = () => {
    ...
    return (
        <div>
            ...
            <button
                onClick={() => setShowInfoModal(true)}
                className="fixed bottom-6 right-24 bg-gradient-to-r from-green-600 to-emerald-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 z-40"
            >
                <BookOpen size={24} />
            </button>
